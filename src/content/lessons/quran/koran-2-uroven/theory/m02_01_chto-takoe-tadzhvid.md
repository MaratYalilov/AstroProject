...
В терминологии чтецов **таджвид** — это **наука о правильном произнесении** букв Корана (полное определение имама аль-Джазари разбирается в отдельном уроке:

> **<span class="arab">اعطاء الحروف حقها ومستحقها</span>...**

). Цель таджвида — читать Коран так, как он **дошёл по непрерывной устной передаче** от Посланника ﷺ.
