  ...
  <div class="theory-hero-inner">
    ...
    <div class="theory-hero-content">
      ...
      <div class="theory-hero-sub">
        Звук «син» образуется при задевании кончиком языка основания нижних резцов без участия голосовых связок.
      </div>
    </div>
  </div>
</div>
  ...
  <div class="flex flex-col sm:flex-row gap-6 items-start">
    <div class="shrink-0 flex flex-col items-center gap-3">
      <img
        ...
        src="/media/quran/muallim-sani/forms/12_sin-isolated.webp"
      >
      <div class="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-white/10 dark:bg-white/[0.04]">
        <span class="text-xs text-gray-500 dark:text-gray-400">Начертание буквы «син»</span>
      </div>
    </div>
    <div class="flex-1">
      <p class="!mt-0 leading-relaxed">
        В написании та же буква «шин» только без точек.
      </p>
    </div>
  </div>
</div>
...
<div class="theory-forms">
  ...
  <div class="theory-card">
    <div class="flex flex-col sm:flex-row gap-6 items-start mb-6">
      <div class="shrink-0 flex flex-col items-center gap-3">
        <img
          ...
          src="/media/quran/muallim-sani/images/makhraj/12_sin.webp"
        >
        <div class="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-white/10 dark:bg-white/[0.04]">
          <span class="font-serif text-2xl leading-none text-fjord-500 dark:text-fjord-400">سِين</span>
          <span class="text-xs text-gray-500 dark:text-gray-400">арабское название</span>
        </div>
      </div>
      <div class="flex-1">
        <p class="!mt-0 leading-relaxed">
          Буква <strong class="text-fjord-600 dark:text-fjord-400">س (син)</strong> — глухой свистящий звук. Образуется при сближении кончика языка с основанием нижних передних зубов, воздух проходит через узкую щель без участия голосовых связок. Практически совпадает с русским «с».
        </p>
      </div>
    </div>
    <!-- Блок: Как произнести -->
    <div class="rounded-xl border border-gray-100 bg-gray-50 p-4 dark:border-white/[0.06] dark:bg-white/[0.02]">
      ...
      <div class="flex flex-col gap-3 sm:flex-row">
        <div class="flex flex-1 items-start gap-3">
          ...
          <p class="!mb-0 text-sm leading-relaxed text-gray-600 dark:text-gray-300"><b class="text-gray-800 dark:text-gray-100">Поднесите</b> кончик языка к основанию нижних передних зубов</p>
        </div>
        <div class="flex flex-1 items-start gap-3">
          ...
          <p class="!mb-0 text-sm leading-relaxed text-gray-600 dark:text-gray-300"><b class="text-gray-800 dark:text-gray-100">Пропустите</b> воздух через узкую щель без голоса</p>
        </div>
        <div class="flex flex-1 items-start gap-3">
          ...
          <p class="!mb-0 text-sm leading-relaxed text-gray-600 dark:text-gray-300"><b class="text-gray-800 dark:text-gray-100">Произнесите</b> свистящий «с-с-с» — тонко, без голоса</p>
        </div>
      </div>
    </div>
    ...
    <!-- ДОПОЛНИТЕЛЬНЫЙ БЛОК: Особенность буквы син -->
    <div class="mt-4 rounded-xl border border-amber-200 bg-amber-50/50 p-4 dark:border-amber-800/40 dark:bg-amber-900/10">
      <p class="mb-2 text-xs font-semibold uppercase tracking-widest text-amber-600 dark:text-amber-400">✨ Особенность буквы син</p>
      <p class="!mb-0 text-sm leading-relaxed text-gray-700 dark:text-gray-300">
        Свойство <strong>сафир</strong> (свист) даёт <strong>س</strong> резкий свистящий призвук. Буква <strong>тонкая</strong>
        (без тафхима): произносится легко, без утолщения и «заполнения» рта.
      </p>
    </div>
    ...
    <div class="mt-4 rounded-xl border border-red-100 bg-red-50/30 p-4 dark:border-red-900/30 dark:bg-red-900/10">
      ...
      <ul class="!mb-0 text-sm leading-relaxed text-gray-700 dark:text-gray-300 space-y-1 pl-4">
        <li><strong class="text-red-700 dark:text-red-400">Утолщение звука</strong> — син должна оставаться тонкой, без «тяжести» и заполнения рта</li>
        <li><strong class="text-red-700 dark:text-red-400">Озвончение в «з»</strong> — син всегда глухая</li>
        <li><strong class="text-red-700 dark:text-red-400">Шепелявость</strong> — кончик языка не должен заходить между зубами</li>
      </ul>
    </div>
  </div>
