  ...
  <div class="theory-hero-inner">
    ...
    <div class="theory-hero-content">
      ...
      <div class="theory-hero-sub">
        Твёрдый звук «ċад» образуется при задевании кончиком языка основания нижних резцов без участия голосовых связок.
      </div>
    </div>
  </div>
</div>
  ...
  <div class="flex flex-col sm:flex-row gap-6 items-start">
    <div class="shrink-0 flex flex-col items-center gap-3">
      <img
        ...
        src="/media/quran/muallim-sani/forms/14_sad-isolated.webp"
      >
      <div class="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-white/10 dark:bg-white/[0.04]">
        <span class="text-xs text-gray-500 dark:text-gray-400">Начертание буквы «ċад»</span>
      </div>
    </div>
    <div class="flex-1">
      <p class="!mt-0 leading-relaxed">
        Написание основной части буквы начинается сразу из-под строки. Под углом 30º двигаемся наверх и направо, вытягивая в форме кабачка или баклажана на размер «әлифа», затем закругляясь к строке, ведём линию по строке налево и пройдя незначительно место начала написания буквы поднимаем зубец на высоту ¼ «әлифа». Высота «кабачка» ½ «әлифа». У отдельной и конечной форм дугообразная часть идентична таковой у буквы «нун». Необходимо обратить внимание на то, что во избежание отрыва руки при письме в средней и конечной формах, лигатура справа продолжается по строке вплоть до «места роста кабачка», где буква уже прописывается как указывалось выше.
      </p>
    </div>
  </div>
</div>
    ...
    <div class="flex flex-col sm:flex-row gap-6 items-start mb-6">
      <div class="shrink-0 flex flex-col items-center gap-3">
        <img
          ...
          src="/media/quran/muallim-sani/images/makhraj/14_sad.webp"
        >
        <div class="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-white/10 dark:bg-white/[0.04]">
          <span class="font-serif text-2xl leading-none text-fjord-500 dark:text-fjord-400">صَاد</span>
