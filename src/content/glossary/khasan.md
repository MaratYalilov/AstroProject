...
description: хасан – это <a href="/glossary/akhlyul-khadis" class="glossary-link" target="_blank" rel="noopener noreferrer">хадис</a> с непрерывным иснадом, все передатчики которого от первого до последнего отличались добросовестностью, но немногим менее точным, чем подобные ему, и передатчики передали его безо всяких отклонений<a title="" href="#_ftn1"><b>[1]
---
