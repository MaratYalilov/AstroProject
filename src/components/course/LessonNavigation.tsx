...
export default function LessonNavigation({
  ...
  const enabledButtonClass =
    "border-gray-200 bg-white/80 shadow-gray-200/60 hover:-translate-y-0.5 hover:border-cyan-300/70 hover:bg-cyan-50/60 hover:shadow-lg hover:shadow-cyan-500/10 active:translate-y-0 active:scale-[0.985] dark:border-white/10 dark:bg-white/[0.06] dark:shadow-none dark:hover:border-cyan-300/35 dark:hover:bg-white/[0.09]";
